...
import scrape.sources.novel.toc.structure.intface.*;
 ...
 *
 */
public class TableOfContent extends NodeImpl implements Portionable {
    private final Map<String, String> map = new HashMap<>();
    private final String location;

    private Node mode;

    public TableOfContent(String title, String location) {
        super(title, "root");
