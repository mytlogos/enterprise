...
public class ControlComm {
    ...
    private void initMap() {
        ...
        initPutInMap(new ShowAnime(), BasicMode.SHOW, BasicModule.ANIME);
        ...
        initPutInMap(new ShowBook(), BasicMode.SHOW, BasicModule.BOOK);
        ...
        initPutInMap(new ShowManga(), BasicMode.SHOW, BasicModule.MANGA);
        ...
        initPutInMap(new ShowNovel(), BasicMode.SHOW, BasicModule.NOVEL);
        ...
        initPutInMap(new ShowSeries(), BasicMode.SHOW, BasicModule.SERIES);
