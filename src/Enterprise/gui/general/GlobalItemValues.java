...
public class GlobalItemValues {
    private List<String> creatorNames = new SetList<>();
    private List<String> sortCreators = new SetList<>();
    private List<String> collections = new SetList<>();
    private List<String> ownStatus = new SetList<>();
